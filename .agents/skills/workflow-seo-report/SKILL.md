...
1. Read `.agents/workflows/seo-report/contract.json` and `.agents/workflows/seo-report/workflow.md`.
2. Read `.agents/skills/seo-report/SKILL.md` and `.agents/skills/seo-quality-gate/SKILL.md`.

---
name: seo-drift-baseline
description: "Define approved pre-change SEO snapshots with explicit credential, tool, access, freshness, scope, and limitation handling."
---

# SEO Drift Baseline

Define bounded approved pre-change SEO snapshots. Separate credential presence, tool availability, access result, data freshness, scope, and business interpretation.

## Operating Contract

1. Resolve project/client/property, scope, date/timezone, sources, caps, and approved evidence path.
2. Check baseline IDs, before-state scope, date/timezone, caps, source freshness, reproducibility, and durable evidence paths separately.

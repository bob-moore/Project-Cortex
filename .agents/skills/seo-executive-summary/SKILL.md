---
name: seo-executive-summary
description: "Produce a client-readable decision summary from approved SEO evidence with source labels, limitations, next actions, and no unsupported business claims."
---

# SEO Executive Summary

Produce a client-readable decision summary from approved evidence. Markdown is the source of truth; optional HTML/PDF is presentation only.
...
- observed facts, interpretation, recommendations, unknowns, material risks, opportunities, decisions, and no business guarantees.
...
```text
# SEO Executive Summary: [Client/Project]
## Report Contract

...
1. Run the project triage script:
   - from this vault skill set: `node <skill-root>/../wp-project-triage/scripts/detect_wp_project.mjs`
   - run it with the target repository as the current working directory.

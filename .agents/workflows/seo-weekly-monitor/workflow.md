...
- Canonical workflow: `seo-weekly-monitor`

## Purpose

Define bounded recurring read-only SEO monitoring with explicit source status, freshness, scope, and limitations.

## Required Context

- `.agents/workflows/seo-weekly-monitor/contract.json`
- `.agents/skills/seo-weekly-monitor/SKILL.md`

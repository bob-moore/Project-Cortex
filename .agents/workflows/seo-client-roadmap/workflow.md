...
- Canonical workflow: `seo-client-roadmap`

## Purpose

Produce a sequenced client roadmap from approved SEO evidence. Markdown is the source of truth; optional HTML/PDF is presentation only.

## Required Context

- `.agents/workflows/seo-client-roadmap/contract.json`
- `.agents/skills/seo-client-roadmap/SKILL.md`

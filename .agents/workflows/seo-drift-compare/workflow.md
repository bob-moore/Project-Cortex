...
- Canonical workflow: `seo-drift-compare`

## Purpose

Define bounded approved before/after SEO snapshot comparison with explicit source status, freshness, scope, and limitations.

## Required Context

- `.agents/workflows/seo-drift-compare/contract.json`
- `.agents/skills/seo-drift-compare/SKILL.md`

...
- Canonical workflow: `seo-quality-gate`

## Purpose

Evaluate an SEO artifact against the canonical discipline rubric without producing or mutating findings.
...
Rubric report shape with mode, blocking findings, applicable scores, skipped checks, evidence labels, limitations, handoffs, and verdict.

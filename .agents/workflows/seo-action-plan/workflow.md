...
- Canonical workflow: `seo-action-plan`

## Purpose

Produce a evidence-backed prioritized action plan from approved SEO evidence. Markdown is the source of truth; optional HTML/PDF is presentation only.

## Required Context

- `.agents/workflows/seo-action-plan/contract.json`
- `.agents/skills/seo-action-plan/SKILL.md`

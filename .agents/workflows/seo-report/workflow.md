...
- Canonical workflow: `seo-report`

## Purpose

Produce a complete Markdown report from approved SEO evidence. Markdown is the source of truth; optional HTML/PDF is presentation only.

## Required Context

- `.agents/workflows/seo-report/contract.json`

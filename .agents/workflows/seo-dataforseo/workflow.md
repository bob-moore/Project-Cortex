...
- Canonical workflow: `seo-dataforseo`

## Purpose

Define bounded DataForSEO provider evidence with explicit source status, freshness, scope, and limitations.

## Required Context

- `.agents/workflows/seo-dataforseo/contract.json`
- `.agents/skills/seo-dataforseo/SKILL.md`

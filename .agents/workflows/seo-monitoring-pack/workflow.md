...
- Canonical workflow: `seo-monitoring-pack`

## Purpose

Produce a recurring operator/client scorecard from approved SEO evidence. Markdown is the source of truth; optional HTML/PDF is presentation only.

## Required Context

- `.agents/workflows/seo-monitoring-pack/contract.json`
- `.agents/skills/seo-monitoring-pack/SKILL.md`

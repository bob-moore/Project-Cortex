...
- Canonical workflow: `seo-drift-baseline`

## Purpose

Define bounded approved pre-change SEO snapshots with explicit source status, freshness, scope, and limitations.

## Required Context

- `.agents/workflows/seo-drift-baseline/contract.json`
- `.agents/skills/seo-drift-baseline/SKILL.md`

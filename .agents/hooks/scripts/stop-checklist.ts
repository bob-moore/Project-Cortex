...
const checklist = [
	...
	"- Archive completed projects? (Projects/active/<Project>/ -> Projects/archive/YYYY/<Project>/)",
	"- Update indexes? (Index.md, harness/memory.md, org/People & Context.md, reviews/Index.md only when review material is in scope)",
	"- New notes linked? (orphans are bugs)",
	"- Run /vault-audit if many notes were created/modified",
].join("\n");

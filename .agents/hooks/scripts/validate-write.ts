 ...
 * skips files outside the vault-note scope (dotfiles, runtime machinery,
 * adapter config, templates, root docs, translated READMEs), and emits a hookSpecificOutput with

 ...
 *
 * Reads the hook JSON payload from stdin, inspects the runtime prompt field
 * for signal patterns (see lib/signals.ts), and emits a hookSpecificOutput
...
if (signals.length > 0) {
	...
	const additionalContext =
		...
		hints +
		"\n\nRemember: use proper templates, add [[wikilinks]], and follow harness/manual.md.";

...
export const SIGNALS: readonly Signal[] = [
	{
		name: "DECISION",
		message:
			"DECISION detected — consider creating a Decision Record in the relevant Projects/active/<Project>/ folder and logging in Projects/Index.md Decisions Log",
		patterns: [
			// English
			"decided",
			"deciding",
	...
	},
	{
		name: "INCIDENT",
		message:
			"INCIDENT detected — consider using /vault-incident-capture or creating an incident note in Notes/incidents/",
		patterns: [
			// English
			"incident",
			"outage",
	...
	},
	{
		name: "1:1 CONTENT",
		message:
			"1:1 CONTENT detected — consider creating a 1-on-1 note in Notes/1-1/ and updating the person note in org/people/",
		patterns: [
			// English
			"1:1",
			"1-1",
	...
	},
	{
		name: "WIN",
		message:
			"WIN detected — consider review evidence only if review/career material is in scope",
		patterns: [
	...
	},
	{
		name: "PROJECT UPDATE",
		message:
			"PROJECT UPDATE detected — consider updating the active project note under Projects/active/<Project>/",
		patterns: [
			// English
			"project update",
			"sprint",

...
Use this file to point at specific harness notes. Do not store important memory
only in runtime-private locations such as `~/.claude/`.

## Topics

- [[operator]]
- [[user]]
- [[harness/north-star|North Star]]
